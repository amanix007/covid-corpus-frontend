...
import { hrcsResearchActivityCategory, hrcsResearchActivitySubcategory } from 'services';

const AdminHrcsResearchActivities = () => {
  ...
  const getCategories = (editionId) => {
    setIsLoading(true);
    const x = hrcsResearchActivityCategory.get().then(categoryList => {
      setListLevel(1);
  ...
  const getSubcategories = (categoryId) => {
    setIsLoading(true);
    const x = hrcsResearchActivitySubcategory.get(categoryId).then(subcategoryData => {
      setListLevel(2);
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-12 col-sm-12 col-md-7 col-lg-9">
              <div className="dk-page-title">HRCS Research Activities Administration</div>
