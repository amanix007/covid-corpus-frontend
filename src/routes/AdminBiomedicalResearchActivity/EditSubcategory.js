        ...
        onSubmit={(values, actions) => {
          if (selectedItem) {
            hrcsResearchActivitySubcategory.update({
              ...
              .then(res => {
                ccToast("SubCategory was successfully updated!", "success")
                // toast.info('SubCategory was successfully updated!', {
                //   position: "top-center",
                //   autoClose: 5000,
            ...
            hrcsResearchActivitySubcategory.create({
              ...
              .then(res => {
                ccToast("SubCategory was successfully completed!", "success")
                // toast.info('SubCategory was successfully created!', {
                //   position: "top-center",
                //   autoClose: 5000,
                //   hideProgressBar: false,
                //   closeOnClick: true,
