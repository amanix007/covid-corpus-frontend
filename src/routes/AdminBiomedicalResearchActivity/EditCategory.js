...
import { hrcsResearchActivityCategory } from 'services';
    ...
    <React.Fragment>
      ...
      <Formik
        ...
        onSubmit={(values, actions) => {
          ...
          if (selectedItem) {
            hrcsResearchActivityCategory.update({
              id: selectedItem.id,
              code: values.code,
              ...
              .then(res => {
                ...
                ccToast("Category was successfully updated!", "success")
              //   toast.info('Category was successfully updated!', {
              //     position: "top-center",
              //     autoClose: 5000,
            ...
            hrcsResearchActivityCategory.create({ 
              code: values.code,
              full_name: values.full_name,
              short_name: values.short_name,
              unique_id: values.unique_id,
              ...
              .then(res => {
                ccToast("Category was successfully completed!", "success")
                // toast.info('Category was successfully created!', {
                //   position: "top-center",
                //   autoClose: 5000,
                //   hideProgressBar: false,
                //   closeOnClick: true,
